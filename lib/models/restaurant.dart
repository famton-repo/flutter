...
class Restaurant extends ChangeNotifier {
  ...
  final List<Food> _menu = [
    ...
    Food(
      name: "Sweet Potato",
      description: "A delightful blend of crispy lettuce, almonds, and crunchy noodles with a tangy sesame dressing.",
    ...
    Food(
      ...
      category: FoodCategory.desserts,
      availableAddons: [
        Addon(name: "Extra cherries", price: 0.99),
      ],
    ),
    Food(
    ...
    Food(
      ...
      availableAddons: [
        ...
        Addon(name: "Splash of Cocount Rum", price: 1.99),
      ],
    ),
    Food(
      ...
      availableAddons: [
        ...
        Addon(name: "Hazelunt Syrup", price: 0.99),
